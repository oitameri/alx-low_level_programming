...
/**
 * check_elf - see file is an ELF file.
 * @e_ident: ptr to arr with the ELF magc nos.
 *
...
/**
 * print_magic - print magc nos of an ELF header.
 * @e_ident: ptr to arr with the ELF magc nos.
 *
 * Description: magc nos are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
    int index;
 ...
 * @e_ident: ptr to arr with the ELF class.
 */
void print_class(unsigned char *e_ident)
{
    printf(" Class: ");
 ...
 *   * @e_ident: ptr to arr with the ELF version.
 *    */
void print_version(unsigned char *e_ident)
{
     printf(" Version: %d",
 ...
 * @e_ident: ptr to arr with the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
